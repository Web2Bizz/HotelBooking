	...
	let columnsGuest = [
		{
			...
			sorter: (a, b) => a.numberGuest.toString().substring(1) - b.numberGuest.toString().substring(1)
		},
		{
			title: 'Клиент',
			dataIndex: 'lastName',
			...
			render: (_, { firstName, lastName, fatherName }) => (
				<div className='d-f jc-sb'>
					{lastName}
					<Tooltip title={lastName + ' ' + firstName + ' ' + fatherName} arrow={false} placement='left'>
