				...
				<Container>
					<>
						<div className='Footer-logo'>
							{footerData.display_logo && (
								<Avatar
									shape='square'
									size={90}
									src={hotelData[0].hotel_logo}
								/>
							)}
						...
						<div className='Footer-links'>
							...
							{footerData.display_social_block && (
								<div style={{ marginRight: '125px' }}>
									...
									{footerData.display_vk && (
										<a
											target='_blank'
											href={`https://vk.com/${footerData.vk_link}`}
										>
									...
									{footerData.display_telegram && (
										<a
											target='_blank'
											href={`https://t.me/${footerData.telegram_link}`}
										>
									...
									{footerData.display_dzen && (
										<a
											target='_blank'
											href={`https://dzen.ru/${footerData.dzen_link}`}
										>
									...
									{footerData.display_youtube && (
										<a
											target='_blank'
											href={`https://youtube.com/${footerData.youtube_link}`}
										>
							...
							<div className='Footer-button'>
								<p>Рассылка</p>
								<span>
									Подписываясь на рассылку, я даю согласие на обработку
									персональных данных и на получение рекламных сообщений и
									новостей о товарах и услугах.
								</span>
								<Button
									type='primary'
									onClick={onSubscribe}
